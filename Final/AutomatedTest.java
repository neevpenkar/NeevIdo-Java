...
public class AutomatedTest {
    public static String tv1 = "1\n100\n1\nIdo\n4\n2.2\nLambo\n3\n4";
    public static void main(String[] args) {
        
        // Defining the routes:
        String[] route1 = new String[]{"42", "35", "17.8"}; // route segment lengths;
        String[] route2 = route1; //new String[]{"4", "5.1", "2"}; // route segment lengths;
        ...
        System.out.println(q1Input);
        InputStream stdin = System.in;
        try {
            System.setIn(new ByteArrayInputStream(q1Input.getBytes()));
            // System.setIn(new ByteArrayInputStream(tv1.getBytes()));
